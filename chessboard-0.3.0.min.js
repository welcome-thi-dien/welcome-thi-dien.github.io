  ...
  window.ChessBoard =
    ...
    function (f, b) {
      ...
      function ga() {
        ...
        !0 === b.sparePieces &&
          (a += '<div class="' + h.sparePieces + ' ' + h.sparePiecesTop + '"></div>');
        a += '<div class="' + h.board + '"></div>';
        !0 === b.sparePieces &&
          (a += '<div class="' + h.sparePieces + ' ' + h.sparePiecesBottom + '"></div>');
        return a + '</div>';
      }
      function A(a) {
        'black' !== a && (a = 'white');
      ...
      function ja(a, e, c) {
        function d() {
          ...
          if (
            f === a.length &&
            (G(), !0 === b.hasOwnProperty('onMoveEnd') && 'function' === typeof b.onMoveEnd)
          )
            b.onMoveEnd(m(e), m(c));
        }
        ...
        if (0 !== arguments.length) {
          for (var a = !0, b = {}, c = 0; c < arguments.length; c++)
            if (!1 === arguments[c]) a = !1;
              ...
              !0 !== d
                ? r(2826, 'Invalid move passed to the move method.', arguments[c])
        ...
        if (!0 !== F(a)) r(6482, 'Invalid value passed to the position method.', a);
          ...
          for (k in d)
            if (!0 === d.hasOwnProperty(k)) {
              ...
              !1 !== l &&
                (f.push({ type: 'move', source: l, destination: k, piece: d[k] }),
                delete c[l],
                delete d[k],
                (h[k] = !0));
            }
      ...
      if (
        ...
        if (
          ...
          ('string' !== typeof b.pieceTheme && 'function' !== typeof b.pieceTheme)
        )
          b.pieceTheme = 'img/chesspieces/wikipedia/{piece}.png';
        if (!0 !== b.hasOwnProperty('appearSpeed') || !0 !== w(b.appearSpeed)) b.appearSpeed = 200;
